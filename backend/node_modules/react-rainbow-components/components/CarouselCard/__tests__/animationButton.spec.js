...
describe('<AnimationButtom />', function () {
  it('should set the right assistive text', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_animationButton["default"], {
  ...
  it('should show the play icon', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_animationButton["default"], null));
