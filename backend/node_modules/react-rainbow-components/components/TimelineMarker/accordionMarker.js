...
var _removeItemFromArray = _interopRequireDefault(require("../AccordionSection/removeItemFromArray"));

var _isInArray = _interopRequireDefault(require("../AccordionSection/isInArray"));
...
function AccordionTimelineMarker(props) {
  ...
  var resolveActiveNamesWhenMultiple = (0, _react.useCallback)(function () {
    ...
    if ((0, _isInArray["default"])(activeNames, currentName)) {
      return (0, _removeItemFromArray["default"])(activeNames, currentName);
    }
